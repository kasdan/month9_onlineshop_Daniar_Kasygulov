...
--
-- Host: localhost    Database: month9_database
-- ------------------------------------------------------
...
CREATE TABLE `orders` (
  ...
  `user_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKkeq4ha3u9m7f5nv9wqyk4lnap` (`basket_id`),
...
CREATE TABLE `photos` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK9aumx23kk2f2b97leep11s255` (`clothes_id`),
  CONSTRAINT `FK9aumx23kk2f2b97leep11s255` FOREIGN KEY (`clothes_id`) REFERENCES `clothes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
